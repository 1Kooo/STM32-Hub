 ...
 *   I2C_HW_RCC   标准库 RCC 位宏：I2C1=I2C1、I2C2=I2C2
 *   I2C_HW_PORT  引脚所在 GPIO 口（F103 两个 I2C 都在 GPIOB）
 *   I2C_HW_SCL_PIN / I2C_HW_SDA_PIN 引脚宏：I2C1=6/7、I2C2=10/11
 *==========================================================*/
#define I2C_HW_X         I2C1                    /* I2C1 或 I2C2 */
#define I2C_HW_RCC       RCC_APB1Periph_I2C1     /* APB1 时钟位 */
#define I2C_HW_PORT      GPIOB                   /* SCL/SDA 所在 GPIO 口 */
#define I2C_HW_SCL_PIN   GPIO_Pin_6              /* SCL 引脚 */
#define I2C_HW_SDA_PIN   GPIO_Pin_7              /* SDA 引脚 */
